import {
  ...
  export default function WithSubnavigation({ selected }) {
    ...
    return (
      <Box>
        <Flex
          bgGradient='linear(to-r, #061A37, #155488)'
          ...
          <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'start' }} align="center">
            ...
            <Flex px={["2"]} flex={0} justify='center' align="center">
              <Image
              src="/static/img/twiddle.svg" 
              alt="Twiddle" 
              w={["25px"]}
              mr={["3"]}/>
            <Text
              ...
              Twiddle <Text color={useColorModeValue('#0BAFF9', '#0BAFF9')} as="span">Project</Text>
            </Text>
            </Flex>
