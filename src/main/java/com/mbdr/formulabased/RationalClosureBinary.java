...
public class RationalClosureBinary implements DefeasibleQueryChecker {
    
    private ArrayList<PlBeliefSet> baseRank;
    private RankConstructor<ArrayList<PlBeliefSet>> constructor;

    public RationalClosureBinary(RankConstructor<ArrayList<PlBeliefSet>> constructor){
        this.constructor = constructor;
    }

    public RationalClosureBinary(ArrayList<PlBeliefSet> baseRank){
